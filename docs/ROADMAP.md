...
6. Produce one reconciled portfolio projection so Summary, Holdings, and Allocation share a snapshot ID, ledger revision, valuation time, and source timestamps.
